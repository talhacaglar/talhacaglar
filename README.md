<p align="center">
  <img src="./assets/night-garage-banner.png" alt="Talha Çağlar — Linux, automation and security. A late-night garage with my mascot, a terminal and a sports car." width="100%" />
</p>
...
<p>Tasks, Pomodoro sessions and focus controls for Arch Linux and Hyprland.</p>
<sub>PYTHON / TEXTUAL / SQLITE</sub>
</td>
<td width="50%" valign="top">
<h3><a href="https://github.com/talhacaglar/archsweep">archsweep</a></h3>
<p>An opt-in terminal cleaner for Arch-based systems. Small, direct, written in Bash.</p>
<sub>BASH / ARCH LINUX</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
<h3><a href="https://github.com/talhacaglar/PrintHub">PrintHub</a></h3>
<p>Network printer, toner, stock and Active Directory management in one desktop application.</p>
